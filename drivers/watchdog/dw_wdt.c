...
static int dw_wdt_set_top(unsigned top_s)
{
	...
	writel(((top_val<<4)|top_val), dw_wdt.regs + WDOG_TIMEOUT_RANGE_REG_OFFSET);
...
//{
//
//	//readl(dw_wdt.regs + WDOG_COUNTER_REG_EOI_OFFSET);
...
#ifndef FPGA_PLATFORM_NPSC01
	dw_wdt.clk = clk_get(&pdev->dev, "wdt_clk");
...
static struct of_device_id a9_wdt_ids[] = {
        { .compatible = "snps,designware-a9wakeup-wdt", },
        { /* sentinel */ }
};
