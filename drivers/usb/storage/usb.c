...
int usb_stor_probe2(struct us_data *us)
{
    ...
    //UsbHostMsgEventSend(dev_name(&us->pusb_intf->dev), 0, 0); //jackson
...
void usb_stor_disconnect(struct usb_interface *intf)
{
    ...
    /*+++jackson
    extern void UsbHostMsgEventSend(char *, int, int);
    struct usb_device *usbdev;  
    usbdev=to_usb_device(intf->dev.parent); 
    printk("==> %s, devpath:%s\n",__func__, usbdev->devpath);
    UsbHostMsgEventSend(usbdev->devpath, 2, 1);
    ---jackson*/
