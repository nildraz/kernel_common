...
#ifdef CONFIG_USB_G_ADB_USE_LARGE_BUF
#define ADB_BULK_BUFFER_SIZE           (64*1024)
#warning "***** DO YOU CONFIRM TO SELECT [CONFIG_USB_G_ADB_USE_LARGE_BUF]? *****"
#else
...
adb_ss_bulk_in_desc = {
	...
	/* bEndpointAddress copied from fs_bulk_in_desc during adb_bind() */
	.bmAttributes =     USB_ENDPOINT_XFER_BULK,
	.wMaxPacketSize =   cpu_to_le16(1024),
};

static struct usb_ss_ep_comp_descriptor adb_ss_bulk_in_comp_desc = {
	.bLength =      sizeof(adb_ss_bulk_in_comp_desc),
	.bDescriptorType =  USB_DT_SS_ENDPOINT_COMP,
};

static struct usb_endpoint_descriptor
adb_ss_bulk_out_desc = {
	.bLength =      USB_DT_ENDPOINT_SIZE,
	.bDescriptorType =  USB_DT_ENDPOINT,

	/* bEndpointAddress copied from fs_bulk_out_desc during adb_bind() */
	.bmAttributes =     USB_ENDPOINT_XFER_BULK,
	.wMaxPacketSize =   cpu_to_le16(1024),
};

static struct usb_ss_ep_comp_descriptor adb_ss_bulk_out_comp_desc = {
	.bLength =      sizeof(adb_ss_bulk_in_comp_desc),
	.bDescriptorType =  USB_DT_SS_ENDPOINT_COMP,
};
...
static struct usb_descriptor_header *adb_ss_function[] = {
	(struct usb_descriptor_header *) &adb_interface_desc,
	(struct usb_descriptor_header *) &adb_ss_bulk_in_desc,
	(struct usb_descriptor_header *) &adb_ss_bulk_in_comp_desc,
	(struct usb_descriptor_header *) &adb_ss_bulk_out_desc,
	(struct usb_descriptor_header *) &adb_ss_bulk_out_comp_desc,
	NULL,
};
/**/
...
//extern int get_adb_module_enable(void);
...
adb_function_bind(struct usb_configuration *c, struct usb_function *f)
{
	...
	if (gadget_is_dualspeed(c->cdev->gadget)) {
		...
		adb_ss_bulk_in_desc.bEndpointAddress =
			adb_fullspeed_in_desc.bEndpointAddress;
		adb_ss_bulk_out_desc.bEndpointAddress =
			adb_fullspeed_out_desc.bEndpointAddress;
	}
...
static int adb_bind_config(struct usb_configuration *c)
{
	...
	dev->function.ss_descriptors = adb_ss_function;
