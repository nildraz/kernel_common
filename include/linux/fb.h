...
/*	The display on this fb_info is in idle mode, no access to the
 *	framebuffer is allowed any more after that call returns
 */
#define FB_EVENT_IDLE_IN         0x12
/*	The display on this fb_info is out of idle mode  , no access to the
 *	framebuffer is allowed any more after that call returns
 */
#define FB_EVENT_IDLE_OUT        0x13
